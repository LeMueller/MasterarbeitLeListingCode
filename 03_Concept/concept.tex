...
\end{figure}
  ...
  \noindent
  Der Form des Zeigers ist die gleich wie auf dem Laptop. Da auf einem Smartphone keine Maus zu Verfügung steht, wird die Bestätigung des Zeigers durch \glqq blickbasierte Selektion\grqq\ (eng. gaze) ausgeführt. Wenn der Zeiger ca. 0,5 Sekunde auf einem Objekt verharrt, wird dadurch die Aktion des jeweiligen Objecktes initiiert.
  
 \subsubsection{Samsung Gear VR}
 Samsung Gear VR ist ein gut verbreitetes mobile HMD im Markt. Es ist ein typisch 3 Dof HMD. Gear VR kann mit oder ohne Controller benutzt werden.
...
HTC Vive                                                                    & Kopf bewegen                                                                                                                                & Trackpad clicken                                                                                                    & \begin{tabular}[c]{@{}l@{}}Aktivieren:\\ Hair-Trigger betätigen\\ \\ Greifen:\\ Hair-Trigger drücken\\ \\ Befreien:\\ Hair-Trigger loslösen\\ \\ Überprüfen:\\ Objekt blickbasiert selektieren\\ und Hair-Trigger clicken\end{tabular} \\ \hline
\end{tabular}
