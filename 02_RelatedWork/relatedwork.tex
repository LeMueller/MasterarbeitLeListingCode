...
E-Learning ist schon ein unverzichtbares pädagogisches Mittel mit hochwertiger wirtschaftlicher Markt. Auf dem E-Learning Markt spielt die Hochschulen eine entscheidende Rolle. (Abbildung ~\ref{fig:zielgruppe})
...
%Die Lernmethoden, beispielsweise Karteikarten, Brainstorming und Tests, gelten als Einflussfaktoren im Vergleich zwischen den Modalitäten des Lernens, nämlich E-Learning und der Unterricht im Klassenzimmer.
...
%Wahrscheinlich ist der Grund, dass mehrer effektive Lernmethoden eingesetzt werden können.
...
%Dank der schnell entwickelnden Web Technik werden mehr Lernmethoden ermöglicht.
...
Zurzeit kann die sich entwickelnde VR Technik die medizinische Ausbildung gut unterstützen, z.B. in den Bereichen von Chirurgie \citep{58} und klinischer Medizin \citep{59}.
...
\vspace*{1em}
\centering
\caption{Aufmerksamkeit Analyse \RomanNumeralCaps{1}}
...
\vspace*{1em}
\centering
\caption{Aufmerksamkeit Analyse \RomanNumeralCaps{2}}
...
\end{figure}
  ...
  Wenn ein HMD drei DoF hat, kann es normalerweise nur die Rotationen erkennen. Wegen der Begrenzung der Leistung ist erfahrungsmäßig ein mobile HMD ein 3 DoF HMD.
...
\end{figure}
  ...
  Es gibt auch HMD wie Google Cardboard und die ältere Version der Gear VR, die keine zugehörigen Controller haben. Normalerweise steht ein Knopf oder ein Trackpad an der Seite des HMDs für Interaktion zur Verfügung.
...
\end{figure}
 ...
 Obwohl zurzeit WebVR noch nicht von allen Browsern unterstützt wird, hat WebVR eine ziemlich breite Zugänglichkeit. (Abbildung ~\ref{fig:supportedBrowsers})
